...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(FOCLWatchSignature, const FString&, FileChanged, EKernelFileChangeAction,
                                             ChangeType);
...
public:
    ...
    UFUNCTION(BlueprintCallable, Category = "OpenCL Functions")
    void RunOpenCLKernel(const FString& Kernel, const FString& KernelName = TEXT("main"),
